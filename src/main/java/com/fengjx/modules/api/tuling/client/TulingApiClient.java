...
package com.fengjx.modules.api.tuling.client;
...
/**
 * 接口申请地址 http://tuling123.com/ 请求方式 Api 地址：
 * http://www.tuling123.com/openapi/api 请求方式： http get 数据格式： json 图灵机器人API
 * Created by fengjx. Date：2014/12/13 0013
 */
public class TulingApiClient {

    // private static final String API_KEY = "790125ff1b12295b6f914e0b2688b429";
    private static final String URL = "http://www.tuling123.com/openapi/api?key=706646227d844d5ea0bcfd39991e5dbc";
    ...
    public static void main(String[] args) {
        ...
        req.setInfo("你好");
        req.setUserid("test");
        System.out.println(call2String(req));
    }
